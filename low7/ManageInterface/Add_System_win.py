from PyQt5.QtWidgets import QWidget, QToolBox, QPushButton, QGridLayout, QLabel, QFrame
...
# 添加系统课件
from ManageOperation import Add_System


class Add_System_win(QFrame):
    def __init__(self, data):
        ...
        self.lab = QLabel()
        self.qtool = QToolBox()
        self.datawindow = Add_System.Add_System(self)
