...
from ManageOperation import Addexfileanswer


class Addexfileanswer_win(QWidget):
    def __init__(self, data, answer):
        super(Addexfileanswer_win, self).__init__()
        self.datawindow = Addexfileanswer.Addexfileanswer(self)
        self.data = data
        self.answer = answer
