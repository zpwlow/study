...
# 管理员修改密码
from ManageOperation import Controller_amend


class Controller_amend_win(QFrame):
    def __init__(self):
        super(Controller_amend_win, self).__init__()
        self.setFrameShape(QFrame.StyledPanel)
        self.setFrameShadow(QFrame.Raised)
        self.datawindow = Controller_amend.Controller_amend(self)
        ...
        self.amendedit1.returnPressed.connect(self.datawindow.enterPress1)
        self.amendedit2.returnPressed.connect(self.datawindow.enterPress2)
        self.sure.clicked.connect(self.datawindow.accept)
        self.devise_ui()
