...
from ManageOperation import Course_news
...
class Course_news_win(QFrame):
    def __init__(self, data):
        ...
        self.addcufile.clicked.connect(self.datawindow.addcufun)
        self.addexfile.clicked.connect(self.datawindow.addexfun)
        self.devise_Ui()
