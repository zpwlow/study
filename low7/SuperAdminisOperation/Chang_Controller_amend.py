...
from SuperAdminisOperation import Edit_Controller
from SuperAdminisInterface.Chang_Controller_amend_win import Chang_Controller_amend_win
...
class Chang_Controller_amend(QFrame):
    def __init__(self,number):
        ...
        self.chang = Chang_Controller_amend_win()
    ...
    def return_fun(self):
        ...
        SuperAdminisOperation.win.splitter.insertWidget(0, Edit_Controller.Edit_Controller(self.number))
