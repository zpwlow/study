...
from SuperAdminisOperation import Record
import sys
...
class QUnFrameWindow(QMainWindow):
    ...
    def __init__(self):  # 设置界面布局，界面大小，声名控件
        ...
        self.setWindowTitle("low_Super_Administrators")
...
if __name__ == "__main__":
    ...
    SuperAdminisOperation.win = QUnFrameWindow()
    SuperAdminisOperation.win.show()
    sys.exit(app.exec_())